...
- Title
- Context7-compatible library ID (e.g., `/kelseyhightower/envconfig`)
- Code Snippets count
...
- **`context7CompatibleLibraryID`** (`string`) *(required)*: Exact Context7-compatible library ID (e.g., '/kelseyhightower/envconfig') retrieved from 'resolve-library-id' or directly from user query in the format '/org/project' or '/org/project/version'

- **`topic`** (`string`) *(optional)*: Topic to focus documentation on (e.g., 'struct tags', 'default', 'required')
...
```bash
# Get Envconfig struct tags documentation (code mode)
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "struct tags", "mode": "code", "page": 1}'

# Get conceptual information about custom decoders
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "custom decoder", "mode": "info"}'

# Get default values examples
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "default", "mode": "code"}'

# Get additional pages for more details
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "struct tags", "mode": "code", "page": 2}'
```
...
```json
{
  ...
  "properties": {
    "context7CompatibleLibraryID": {
      "type": "string",
      "description": "Exact Context7-compatible library ID (e.g., '/kelseyhightower/envconfig') retrieved from 'resolve-library-id' or directly from user query in the format '/org/project' or '/org/project/version'."
    },
    "topic": {
      "type": "string",
      "description": "Topic to focus documentation on (e.g., 'struct tags', 'default')."
    },
    "mode": {
      "type": "string",
      "enum": ["code", "info"],
...
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t resolve-library-id -p '{"libraryName": "envconfig"}'

# Step 2: Use returned ID to fetch docs
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "struct tags"}'
```
...
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "default values"}'
```
...
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "getting started", "mode": "info"}'

# Then drill into specifics
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "custom decoder", "mode": "code"}'
```
...
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "struct tags", "page": 1}'

# Get additional pages as needed
python3 scripts/mcp-client.py call -s "npx -y @upstash/context7-mcp" \
  -t get-library-docs \
  -p '{"context7CompatibleLibraryID": "/kelseyhightower/envconfig", "topic": "struct tags", "page": 2}'
```
